...
public class MainApp extends Application {
    ...
    private void initContent(GridPane pane) {
        ...
        txfName.setOnMouseClicked(event -> controller.mouseClicked(event));
        ...
        txfAddress.setOnMouseClicked(event -> controller.mouseClicked(event));
    }
    ...
    private class Controller {
        private void mouseClicked(MouseEvent event) {
            ...
            if (txf == txfName) {
                txf.setStyle("-fx-text-fill: cornflowerblue");
            }
            if (txf == txfAddress) {
                txf.setText("Clicked");
            }
